...
public class E10 : MonoBehaviour {
	...
	*/
	...
	void Start () {
		...
		string arrayA = (sumaA % 2 == 0) ? "La suma de los elementos de A es par" : "La suma de los elementos de A es impar";

		string arrayB = (sumaB % 2 == 0) ? "La suma de los elementos de B es par" : "La suma de los elementos de B es impar";
