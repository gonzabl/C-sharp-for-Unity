...
public class E11 : MonoBehaviour {
	...
	void Start () {
		...
		switch (clave){
		case "1234": Debug.Log("Usuario ha accedido");
					accesos[0]++;
					break;
		case "3141": Debug.Log("Editor ha accedido");
					accesos[1]++;
					break;
		case "8007": Debug.Log("Administrador ha accedido");
					 accesos[2]++;
					 break;
		default: Debug.Log("Acceso no permitido!");
				 break;
		}
