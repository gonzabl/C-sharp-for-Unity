...
public class E08 : MonoBehaviour {
	...
	*/
	...
	void Start () {
		...
		Debug.Log("true || true = "+trueORtrue); //true
		Debug.Log("true || false = "+trueORfalse); // true
		Debug.Log("false || true = "+falseORtrue); //true
		Debug.Log("false || false = "+falseORfalse); //false
	...
	*/
	...
	void Start () {
		...
		Debug.Log ("¿Esta el valor " + edad + " fuera del intervalo [18,30] -->" + fueraDelIntervalo);
