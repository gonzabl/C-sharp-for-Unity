...
public class E07 : MonoBehaviour {
	...
	*/
	...
	void Start () {
		...
		textoEdadJose = textoEdadJose + edadJose;
		textoEdadMaria = textoEdadMaria + edadMaria;
	...
	*/
	...
	void Start () {
		...
		//int[] array = new int[5]; forma mas simple
		int[] enteros={0,0,0,0,0};
