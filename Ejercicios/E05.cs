...
public class E05 : MonoBehaviour {
	...
	*/
	...
	void Start () {
		...
		// iniciales y luego otra vez las mismas exceptuando el nombre
		// y edad, que seran distintos)				
		
		// 3g. Depura lo que llevamos de codigo comprobando en todo
		// momento con el depurador que el valor de las variables es
		// el esperado. (Yo usare la ventana de Locals)
	}
	*/
